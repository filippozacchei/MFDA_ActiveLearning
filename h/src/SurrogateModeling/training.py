...
def train(config_file):
    ...
    try:
        ...
        model = NN_Model()
        model.build_model(input_shape=(data_processor.X_train_vec.shape[1]),
        ...
        model.train_model(X=data_processor.X_train_vec,
                          y=data_processor.y_train_vec,
                          X_val=data_processor.X_test_vec,
                          y_val=data_processor.y_test_vec,
