...
class NN_Model:
    ...
    def build_model(self,  
        ...
        self.model.add(Dense(n_neurons[0], activation=activation, input_shape=(input_shape,), kernel_initializer=initializer, kernel_regularizer=l2(lambda_coeff)))        
    ...
    def train_model(self, 
        ...
        self.model.compile(loss=loss, metrics=['mse'],optimizer=Adam(learning_rate=learning_rate))
